...
| 11 | `11-master-prompt-ai-agent.md` | **Master prompt siap pakai untuk AI coding agent (OpenCode/Claude Code/dll) yang akan mengeksekusi seluruh blueprint ini jadi kode** |
...
9. Pakai `11-master-prompt-ai-agent.md` → copy-paste ini sebagai prompt awal ke AI coding agent kamu (OpenCode/Claude Code/Cursor) supaya agent baca semua file di atas dan eksekusi coding-nya terstruktur, bukan ngarang sendiri.
